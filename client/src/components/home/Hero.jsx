...
import {
    Cpu,      // Represents AI/Processing
    Database, // Represents Storage
    Shield,   // Represents Security/Auth
    Zap,      // Represents Speed/Performance
    Globe     // Represents Deployment/Public links
} from 'lucide-react'
            ...
            <div className="min-h-screen pb-20">
                ...
                <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm">
                    ...
                    <div className="hidden md:flex items-center gap-8 transition duration-500 text-slate-800">
                        ...
                        <a href="#cta" className="hover:text-amber-600 transition">Contact</a>
                    </div>

                    <div className="flex gap-2">
                        <Link to='/app?state=register' className="hidden md:block px-6 py-2 bg-[#EEA727] hover:bg-amber-500 active:scale-95 transition-all rounded-full text-white" hidden={user}>
                            Get started
                        </Link>
                        ...
                        <Link to='/app' className='hidden md:block px-8 py-2 bg-[#EEA727] hover:bg-amber-500 active:scale-95 transition-all rounded-full text-white' hidden={!user}>
                            Dashboard
                        </Link>
                    </div>
                ...
                <div className={`fixed inset-0 z-[100] bg-black/40 text-black backdrop-blur flex flex-col items-center justify-center text-lg gap-8 md:hidden transition-transform duration-300 ${menuOpen ? "translate-x-0" : "-translate-x-full"}`} >
                    ...
                    <button onClick={() => setMenuOpen(false)} className="active:ring-3 active:ring-white aspect-square size-10 p-1 items-center justify-center bg-amber-600 hover:bg-amber-500 transition text-white rounded-md flex" >
                        X
                    </button>
                </div>
                ...
                <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
                    <div className="absolute top-28 xl:top-10 -z-10 left-1/4 size-72 sm:size-96 xl:size-120 2xl:size-132 bg-amber-300 blur-[100px] opacity-30"></div>
                    ...
                    <h1 className="text-5xl md:text-6xl font-semibold max-w-5xl text-center mt-4 md:leading-[70px]">
                        Land your dream job with <span className=" bg-gradient-to-r from-[#EEA727] to-[#EEA722]  bg-clip-text text-transparent text-nowrap">AI-powered </span> resumes.
                    </h1>
                    ...
                    <div className="flex items-center gap-4 ">
                        <Link to='/app' className="bg-[#EEA727] hover:bg-[#e39403] text-white rounded-full px-9 h-12 m-1 ring-offset-2 ring-1 ring-[#EEA722]  flex items-center transition-colors">
                            Get started
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-arrow-right ml-1 size-4" aria-hidden="true"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg>
                        </Link>
                        <button className="flex items-center gap-2 border border-slate-400 hover:bg-amber-50 transition rounded-full px-7 h-12 text-slate-700">
